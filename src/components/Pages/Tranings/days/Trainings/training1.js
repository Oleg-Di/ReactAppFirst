    ...
    return(
        <div className='Trainings__display'>
           ...
           <div>
               <div>
                   <h2>Breast:</h2>
                    {state.trainigOne.tranings[1].chest.map((item, i) => {
                       return(
                        <div key={i + 1} className="Trainings__display__cont">
                        <h3 className='Trainings__display__cont__item'>{item.name}:</h3>
                        <h3 >{item.times}</h3>
                        <div className="form-check ">
                                <input className="form-check-input"  value={value} onChange={()=>checker(item.id)} type="checkbox" id="flexSwitchCheckDefault"/>
               ...
               <div>
                   <h2>Arms:</h2>
                   <div>
                       {state.trainigOne.tranings[2].arms[0].biceps.map((item, i) => {
                           return(
                            <div key={i + 1} className="Trainings__display__cont">
                            <h3 className='Trainings__display__cont__item'>{item.name}:</h3>
                            <h3>{item.times}</h3>
